    ...
    <article className="flex gap-8 pb-12 mb-12 border-b border-gray-200 last:border-b-0">
      <div className="shrink-0 w-56 h-44">
        {post.image && !imgError ? (
          ...
          <div className="w-full h-full rounded-lg bg-linear-to-br from-gray-100 to-gray-200 flex flex-col items-center justify-center gap-2">
            ...
            <span className="text-xs text-gray-400 font-medium">Sem imagem</span>
          </div>
        )}
      </div>
